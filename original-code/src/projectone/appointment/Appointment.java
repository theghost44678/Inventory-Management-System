...
public class Appointment {
    ...
    public Appointment(String appointmentID, Instant appointmentDate, String description, Instant now) {
        // Algorithmic Boundary Guard: Strict null and length constraints prevent exploitation
        if (appointmentID == null || appointmentID.trim().isEmpty() || appointmentID.length() > MAX_ID_LENGTH) {
            throw new IllegalArgumentException("Appointment ID must not be null, empty, and cannot exceed " + MAX_ID_LENGTH + " characters.");
        }
    ...
    public void setAppointmentDate(Instant appointmentDate, Instant now) {
        ...
        // Algorithmic Time Validation Principle
    ...
    public void setDescription(String description) {
        if (description == null || description.trim().isEmpty() || description.length() > MAX_DESCRIPTION_LENGTH) {
            throw new IllegalArgumentException("Description must not be null, empty, and cannot exceed " + MAX_DESCRIPTION_LENGTH + " characters.");
        }
